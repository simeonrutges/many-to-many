...
import com.example.manytomany.services.TelevisionService;
import com.example.manytomany.services.TelevisionWallBracketService;
...
//    }
    // krijgt alleen de ID van de Ci module. one to many
